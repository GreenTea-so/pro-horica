...
export default function Delivery() {
  return (
    <html>
      <meta
        name="keywords"
        content="холодильник из нержавеющей стали, Холодильник, шкаф холодильный, витрина, витринный холодильник, холодильная витрина, барный холодильник, холодильник для напитков, морозилка, полайр, polair, морозильная камера, оборудование для кафе бу"
      />
