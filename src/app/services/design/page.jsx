...
export default function Design() {
  return (
    <html>
      <meta
        name="keywords"
        content="комплект оборудования для кафе, комплект мебели для кафе, выкуп мебели и оборудования, оборудование для пекарни, оборудование для пищевого производства, оборудование для общепита"
      />
      ...
      <body>
        <div id="body">
          <Header />
          <main>
            <BannerDesign hiddenButton={true} />
            ...
            <p className="text">Чтобы ваш ресторан приносил хорошую прибыль, он должен не только радовать гостей вкусным и разнообразным меню, но и быть грамотно организованным внутри. Кухонное, барное и холодильное оборудование необходимо разместить так, чтобы персоналу было удобно работать, а процесс приготовления и подачи блюд проходил максимально эффективно.</p>
            <p className="text">Перед тем как открыть ресторан, важно четко определить оптимальную площадь для комфортного обслуживания гостей и работы сотрудников. В процессе планировки и расстановки оборудования наши специалисты учитывают все пожелания клиента, при этом опираясь на профессиональные стандарты организации ресторанного пространства.</p>
